"""
Django settings for dmrserver project.
...
SECRET_KEY = 'django-insecure-@3%^s-%n#fh(h+7eugqswc6&60-)w4uwe9$1k2-6&hjb^ay@z#'
...
WSGI_APPLICATION = 'dmrserver.wsgi.application'
